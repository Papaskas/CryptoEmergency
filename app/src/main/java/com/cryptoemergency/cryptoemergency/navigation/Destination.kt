...
/**
 * Класс, представляющий различные маршруты в приложении. Этот класс гарантирует,
 * что в нем определены все возможные маршруты, обеспечивая безопасность типов.
 * Внутри определяются интерфейс для блокировки редиректа на них.
 *
 * В release сборке имена классов минифицируется, аннотация [Keep] пропускает минификацию
 **/
@Keep
@Serializable
